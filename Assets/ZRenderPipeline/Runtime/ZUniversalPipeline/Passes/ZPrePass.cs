...
{
    public class ZPrePass : ZScriptableRendererPass
    {
        ...
        public override void Create()
        {
            ...
            m_DreawingSettings.SetShaderPassName(0, new ShaderTagId("ZPreDepth"));
        ...
        public override void ExecuRendererPass(ScriptableRenderContext context, CommandBuffer cmd, ref ZRenderingData renderingData)
        {
            ...
            cmd.SetRenderTarget(targetPass.CameraDepthTarget, RenderBufferLoadAction.DontCare, RenderBufferStoreAction.Store);
