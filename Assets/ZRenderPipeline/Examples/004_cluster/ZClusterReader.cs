...
public class ZClusterReader : MonoBehaviour
{
    ...
    public void Test01()
    {
        ...
        for (int i = 0; i < m_meshes.Length; i++)
        {
            ...
            Span<byte> spanVertexIndex = new Span<byte>(mesh.UniqueVertexIndices);

            Debug.LogWarning("xxxx" + MemoryPackSerializer.Deserialize<uint>(spanVertexIndex.Slice(0, 4)));
    ...
    public struct ClusterMesh
    {
        ...
        public Triangle[] UniquePrimitiveIndices;
