...
namespace UnityEditor.Rendering.ZRendering
{
    ...
    /// </summary>
    [CustomEditor(typeof(ZScriptableRendererData), true)]
    public class ZScriptableRendererDataEditor : Editor
    {
        class Styles
        {
        ...
        {
            m_RendererFeatures = serializedObject.FindProperty(nameof(ZScriptableRendererData.m_RendererFeatures));
            m_RendererFeaturesMap = serializedObject.FindProperty(nameof(ZScriptableRendererData.m_RendererFeatureMap));
        ...
        private void DrawRendererFeatureList()
        {
            ...
            using (var hscope = new EditorGUILayout.HorizontalScope())
            {
                if (GUILayout.Button("Add Renderer Feature", EditorStyles.miniButton))
                {
                    ...
                    FilterWindow.Show(pos, new ZScriptableRendererFeatureProvider(this));
                }
            }
        }
        ...
        {
            var isSingleFeature = type.GetCustomAttribute<ZDisallowMultipleRendererFeature>();
        ...
        private void DrawRendererFeature(int index, ref SerializedProperty renderFeatureProperty)
        {
            ...
            else
            {
                ...
                {
                    ZScriptableRendererData data = target as ZScriptableRendererData;
        ...
        private void RemoveComponent(int id)
        {
            ...
            if (component != null)
            {
                ...
                ZScriptableRendererPass feature = component as ZScriptableRendererPass;
                feature?.Dispose();
            }
