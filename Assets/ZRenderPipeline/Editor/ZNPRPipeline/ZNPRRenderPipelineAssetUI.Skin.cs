...
namespace UnityEditor.Rendering.ZRendering.NPR
{
    internal partial class ZNPRRenderPipelineAssetUI
    {
        internal static class Styles
        {
            ...
            {
                EditorGUIUtility.TrTextContent(nameof(ZSoftShadowQuality.Low)),
                EditorGUIUtility.TrTextContent(nameof(ZSoftShadowQuality.Medium)),
                EditorGUIUtility.TrTextContent(nameof(ZSoftShadowQuality.High))
            };
            public static int[] softShadowsQualityAssetValues = { (int)ZSoftShadowQuality.Low, (int)ZSoftShadowQuality.Medium, (int)ZSoftShadowQuality.High };
